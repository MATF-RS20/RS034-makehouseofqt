...
InputDialog::InputDialog(QWidget *parent)
  ...
  ui->setupUi(this);
  connect(this, SIGNAL(isFinished()), parent, SLOT(changedParams()),
          Qt::DirectConnection);
}
...
float InputDialog::height() const { return _height; }

float InputDialog::thickness() const { return _thickness; }
